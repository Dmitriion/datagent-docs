...
> **Зачем:** Держать «зачем мы это делаем» на виду — цель квартала, под ней задачи и agent, а не разрозненный список тикетов.

**Цель (goal)** — долгосрочный ориентир: сформулировали результат, отслеживаете статус, связываете с **задачами** и [проектами](./projects). Это не замена задачи: цель — направление, задача — конкретная работа agent.
