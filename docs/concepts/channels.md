...
Формулировка для коллег: «Подключили **управление диалогом и агентом** в Datagent, а не всю CRM».
...
- **Пройдите учебник** — [пульт в мессенджерах](/docs/guides/06-channels): от сообщения до ответа
- **Автоматизируйте CRM** — [туториал](/docs/tutorials/automate-crm): Bitrix24 и Телеграм в связке
- **Разберите входящие** — [inbox](/docs/concepts/inbox) · [согласования](/docs/concepts/approvals)
- **Подготовьте компанию** — [настройки](/docs/concepts/company-settings): plugin и секреты для каналов
