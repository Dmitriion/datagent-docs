...
**Мария** получает `.xlsx` с планом продаж и `.pptx` для правок. Схема «скинь в чат с моделью» ломает таблицы и слайды. Агент работает с **файлом на задаче**: вы видите **план изменений** и проходите **одобрение** до применения — как в [главе про согласования](./04-trust-and-approval).
