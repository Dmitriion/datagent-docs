...
**Мария** живёт в **Битрикс24** и **Телеграм**: клиенты пишут туда, а копировать каждый диалог в панель вручную — лишняя работа. «Бот в CRM без журнала» тоже не подходит: непонятно, кто что запустил и на каком основании ушёл ответ. В Datagent каналы ведут в **задачи с журналом** — с памятью, согласованиями и единой перепиской по теме.
