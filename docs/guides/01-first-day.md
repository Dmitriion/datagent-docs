...
![Боковая панель Board: задачи, агенты, одобрения и офис](/img/guides/first-day/sidebar-overview.webp)

*Боковая панель — четыре опоры навигации в одном месте.*
...
![Список задач компании в Board](/img/guides/first-day/issues-list.webp)

*Список задач — точка входа в контекст и журнал run.*

![Карточка задачи с журналом run](/img/guides/first-day/issue-run.webp)

*Внутри задачи видны статус run и шаги агента — не «чат без памяти».*

![Мобильная навигация: боковая панель на узком экране](/img/guides/first-day/sidebar-mobile.webp)

*На телефоне те же разделы открываются через кнопку «Открыть боковую панель».*
