...
Мария открывает задачу вечером и видит **готовый ответ агента** плюс журнал шагов — это можно переслать руководителю ссылкой на карточку, а не скриншотом из чата.
