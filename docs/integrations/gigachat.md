...
**GigaChat** — «мозг» агента: вы один раз указываете ключи из [кабинета разработчика Сбера](https://developers.sber.ru/), выбираете модель в панели — и агент работает в российском контуре.
