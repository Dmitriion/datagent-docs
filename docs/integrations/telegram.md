...
**Нет.** Пока бот недоступен, сообщение не попадёт в Datagent — после восстановления связи отправьте снова или поставьте задачу в панели. Уведомления о согласованиях ждут в очереди, пока плагин **Телеграм** в статусе «работает».
