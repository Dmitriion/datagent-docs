...
> **Этот туториал для разработчиков**, которые создают собственные плагины.  
> Если вы хотите подключить **готовый** плагин — смотрите [Управление плагинами](/docs/cloud/plugins).  
> Если вы **оператор** — смотрите [Автоматизация CRM](/docs/tutorials/automate-crm).
