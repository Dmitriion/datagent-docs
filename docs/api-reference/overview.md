...
| Тема | Статус | Ссылка |
| --- | --- | --- |
| Аутентификация, схема | в этом документе | [ниже](#аутентификация) |
| Агенты, wakeup, keys | в этом документе | [Агенты](#агенты) |
| Задачи (issues) | 🟡 только здесь | [Задачи и согласования](#компании-задачи-и-согласования) → `api-reference/issues` (P2) |
| Память (layers, chunks) | 🟡 stub | [Память (API)](./memory) |
| Артефакты компании | 🟡 в обзоре | [Артефакты](../artifacts/overview) → `api-reference/artifacts` (P2) |
| Плагины, tools | в этом документе | [Плагины](#плагины) |
